...
class MojoomViewGroup_video extends JView
{
	function display($tpl = null)
	{
		...
		$group_video			= $model->getGroup_video($filters,$groupId);
		$width = 112;
		$height = 84;
		$this->assignRef( 'videos',	$group_video );
...

		{
...

			{
				...
				case ( $days > 365 ):
					...
					$html	.= JText::sprintf( $this->_isPlural( $years ) ? '%1$s years' : '%1$s year' , $years ) . ' ';
