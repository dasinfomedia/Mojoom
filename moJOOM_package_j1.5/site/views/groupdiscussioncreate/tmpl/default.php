...
else
{
	...
	$document->setTitle(JText::_('ADD DIS TITLE'));
...
<table class="formtable">
	...
	<tr class="fromrow">
		<td class="key" >
			<label for="title" class="label" style="text-align: left;">*<?php echo JText::_('DIS TITLE'); ?></label>
		</td>
	</tr>
	<tr class="fromrow">
		<td class="value" >
	...
	<tr class="fromrow">
		<td class="key" >
			<label for="message" class="label" style="text-align: left;">*<?php echo JText::_('DIS MSG'); ?></label>
		</td>
	</tr>
	<tr class="fromrow">
		<td class="value" >
	...
	<tr class="fromrow">
		<td class="key">
			<label for="title" class="label">*<?php echo JText::_('DIS TITLE'); ?></label>
		</td>
	</tr>
	<tr class="fromrow">
		<td class="value">
	...
	<tr class="fromrow">
		<td class="key">
			<label for="message" class="label">*<?php echo JText::_('DIS MSG'); ?></label>
		</td>
	</tr>
	<tr class="fromrow">
		<td class="value"> 
