<?php  
/**
 * Group Wall Model for Mojoom Component
 * 
 * @package    Mojoom
...
class MojoomModelGroup_wall extends JModel
{
	...
	function SaveGroupWall($data)
	{
		$my = CFactory::getUser();
		$wallid = $this->saveWall( $data['group_id'] , $data['message'] , 'groups' , $my , $my->id , 'groups,groups');
	...
	function SaveGroupWallInner($data)
	{
		$db =& JFactory::getDBO();
	...
	function RemoveGroupWallComment($data)
	{
		$db =& JFactory::getDBO();
